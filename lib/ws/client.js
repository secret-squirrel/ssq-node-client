...
function WsClient(uri) {
  ...
  function rsvp(method, params, callback) {
    var msg = request.rsvp(method, params)
  ...
  function notify(method, params, callback) {
    ws.send(JSON.stringify(request.notify(method, params)), callback)
  }
